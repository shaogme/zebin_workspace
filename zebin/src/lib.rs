...
pub mod prelude {
    ...
    pub use crate::{
        ...
        io::{
            ...
            ArchivedLayout, Cursor, CursorMut, Deserialize, FixedLayout, MeasureBody, SchemaAware,
            Serialize, Serializer, SinkProgress, SliceSerializer, Storage, StorageMut, ZebinReader,
            ZebinWriter, deserialize, reader, writer,
        },
